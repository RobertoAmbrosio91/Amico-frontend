...
const Policy: React.FC = () => {
  return (
    <ScrollView showsVerticalScrollIndicator={false} style={styles.container}>
      <View>
        <View>
          <Text style={styles.header}>Amico Privacy Policy</Text>

          <Text style={styles.subHeader}>Introduction</Text>
          <Text>
            Amico (“we,” “our,” or “us”) is committed to protecting your
            privacy.
          </Text>
        ...
        <View style={styles.listContainer}>
          <Text style={styles.bulletText}>
            <Text style={styles.bulletTitle}>• Cookie:</Text> small amount of
            data generated by a website and saved by your web browser.
          </Text>
          <Text style={styles.bulletText}>
            <Text style={styles.bulletTitle}>• Company:</Text> when this policy
            mentions “Company,” “we,” “us,” or “our,” it refers to Noosk, Inc.,
            1209 Orange Street, Wilmington (DE), 19801 that is responsible for
            your information under this Privacy Policy.
          </Text>
          <Text style={styles.bulletText}>
            <Text style={styles.bulletTitle}>• Country:</Text> where Amico or
            the owners/founders of Amico are based, in this case is United
            States.
          </Text>
          <Text style={styles.bulletText}>
            <Text style={styles.bulletTitle}>• Customer:</Text> refers to the
            person that signs up to use the Amico Service.
          </Text>
          <Text style={styles.bulletText}>
            <Text style={styles.bulletTitle}>• Device:</Text> any internet
            connected device such as a phone, tablet, computer or any other
            device that can be used to visit Amico and use the services.
          </Text>
          <Text style={styles.bulletText}>
            <Text style={styles.bulletTitle}>• IP address:</Text> Every device
          ...
          <Text style={styles.bulletText}>
            <Text style={styles.bulletTitle}>• Personnel:</Text> refers to those
            individuals who are employed by Amico or are under contract to
            perform a service on behalf of one of the parties.
          </Text>
          <Text style={styles.bulletText}>
            <Text style={styles.bulletTitle}>• Personal Data:</Text> any
          ...
          <Text style={styles.bulletText}>
            <Text style={styles.bulletTitle}>• Service:</Text> refers to the
            Amico service provided by Amico as described in the relative terms
            (Terms of Use - include link to terms of use) and on this platform.
          </Text>
          <Text style={styles.bulletText}>
            <Text style={styles.bulletTitle}>• Third-party service:</Text>{" "}
          ...
          <Text style={styles.bulletText}>
            <Text style={styles.bulletTitle}>• Website:</Text> Amico's site,
            which can be accessed via this URL: www.Amico.co
          </Text>
          <Text style={styles.bulletText}>
            <Text style={styles.bulletTitle}>• Mobile Application:</Text> Amico,
            which can be accessed by downloading it from Apple Store or Google
            Play Store
          </Text>
          <Text style={styles.bulletText}>
            <Text style={styles.bulletTitle}>• You:</Text> a person or entity
            that is registered with Amico to use the Services.
          </Text>
        </View>

        <Text style={styles.subHeader}>2. What Information Do We Collect?</Text>
        <Text>
          We collect information from you when you visit our website, download
          and use our mobile app, register on our site, subscribe to our
          newsletter, respond to a survey or fill out a form.
        </Text>
        <View style={styles.listContainer}>
          <Text style={styles.bulletTitle}>• Name / Username</Text>
          <Text style={styles.bulletTitle}>• Email Addresses</Text>
          <Text style={styles.bulletTitle}>• Phone Numbers</Text>
          <Text style={styles.bulletTitle}>
            • Some Additional Personal Data (such as, but not limited to,
            Languages spoken, Nationality){" "}
          </Text>
          <Text style={styles.bulletTitle}>• Photos and Videos</Text>
          <Text style={styles.bulletTitle}>• Password</Text>
        </View>

        <Text>
          {" "}
          {"\n"} We also collect information from mobile devices for a better
          user experience. Although these features are completely optional, they
          are crucial to fully experience Amico:
        </Text>
        <View style={styles.listContainer}>
          <Text style={styles.bulletText}>
            <Text style={styles.bulletTitle}>
            ...
            Granting camera permission allows the user to upload any picture or
            video straight from the phone or computer. You can safely deny
            camera permissions for this Website and Mobile App.
          </Text>
          <Text style={styles.bulletText}>
            <Text style={styles.bulletTitle}>
              • Photo Gallery (Pictures and Videos):
            </Text>{" "}
            Granting photo and video gallery access allows you to upload any
            picture or video from your photo and video gallery. You can safely
            deny photo gallery access for this Website and Mobile App.
          </Text>
        </View>
        ...
        <View style={styles.listContainer}>
          ...
          <Text style={styles.bulletText}>
            <Text style={styles.bulletTitle}>• To improve our mobile app:</Text>{" "}
            we continually strive to improve our mobile app based on the
          ...
          <Text style={styles.bulletText}>
            <Text style={styles.bulletTitle}>• To process transactions</Text>
          </Text>
          <Text style={styles.bulletText}>
            <Text style={styles.bulletTitle}>
          ...
          <Text style={styles.bulletText}>
            <Text style={styles.bulletTitle}>• To send periodic emails</Text>
          </Text>
        </View>

        <Text style={styles.subHeader}>
          4. When does Amico use end user information from third parties?
        </Text>
        <Text>
          Amico will collect End User Data necessary to provide the Amico
        ...
        <Text style={styles.subHeader}>
          5. When does Amico use customer information from third parties?
        </Text>
        <Text>
          ...
          interest in becoming an Amico user, we receive information from a
          third party that provides automated fraud detection services to Amico.
        ...
        <View style={styles.listContainer}>
          ...
          <Text style={styles.bulletText}>
            We may share portions of our log file data for analytics purposes
            with third parties such as web analytics partners, application
            developers, and ad networks. If your IP address is shared, it may be
            used to estimate general location and other technographics such as
            connection speed, whether you have visited the website in a shared
            location, and type of the device used to visit the website. They may
            aggregate information about our advertising and what you see on the
            website and then provide auditing, research and reporting for us and
            our advertisers.
          </Text>
        </View>

        <Text style={styles.subHeader}>
          7. Where and when is information collected from customers and end
          users?
        </Text>
        <Text>
        ...
        <Text>
          By submitting your email address on Amico's Website or Mobile
          Application, you agree to receive emails from us. You can cancel your
          participation in any of these email lists at any time by clicking on
          the opt-out link or other unsubscribe option that is included in the
          respective email. We only send emails to people who have authorized us
          to contact them, either directly, or through a third party. We do not
          send unsolicited commercial emails, because we hate spam as much as
          you do. By submitting your email address, you also agree to allow us
          to use your email address for customer audience targeting on sites
          like Facebook, where we display custom advertising to specific people
          who have opted-in to receive communications from us. Note: If at any
        ...
        <Text>
          We keep your information only so long as we need it to provide the
          Service to you and fulfill the purposes described in this policy. This
          is also the case for anyone that we share your information with and
          anyone who carries out services on our behalf. When we no longer need
          ...
          it from our systems or depersonalize it so that we can't identify you.
        </Text>
        ...
        <Text>
          ...
          absolute security of any information you transmit to Amico or
        ...
        <Text style={styles.subHeader}>
          12. Could my information be transferred to other countries?
        </Text>
        <Text>
          Amico is incorporated in United States. Information collected via our
        ...
        <Text style={styles.subHeader}>
          13. Is the information collected through the Service secure?
        </Text>
        <Text>
        ...
        <Text style={styles.subHeader}>
          14. Can I update or correct my information?
        </Text>
        <Text>
          The rights you have to request updates or corrections to the
          information Amico collects depend on your relationship with Amico.
        ...
        <Text>
          If you are a Amico worker or applicant, we collect information you
        ...
        <Text>
          ...
          of the assets of Amico or any of its Corporate Affiliates (as defined
          herein), or that portion of Amico or any of its Corporate Affiliates
        ...
        <Text>
          ...
          Amico, whether by ownership or otherwise. Any information relating to
        ...
        <Text>
          This Privacy Policy applies only to the Services offered by Amico.
          Amico may contain links to other websites not operated or controlled
          by Amico. We are not responsible for the content, accuracy or opinions
        ...
        <Text>
          Amico uses "Cookies" to identify the areas of our Website that you
        ...
        <Text>
          ...
          not be able to fully utilize all of its features and services.
        </Text>
        ...
        <Text>
          You acknowledge and agree that Amico shall not be responsible for any
          ...
          or any other aspect thereof. Amico does not assume and shall not have
        ...
        <Text>
          ...
          the EU residents have, over their personal data.The GDPR is relevant
          to any globally operating company and not just the EU-based businesses
          and EU residents. Our customers’ data is important irrespective of
          where they are located, which is why we have implemented GDPR controls
        ...
        <Text>
          ...
          reasonably expect. Personal data should only be collected to fulfil a
          ...
          collect it. Personal data should be held no longer than necessary to
          fulfil its purpose. People covered by the GDPR have the right to
          access their own personal data. They can also request a copy of their
          data, and that their data be updated, deleted, restricted, or moved to
        ...
        <Text>
          ...
          right thing to do. At Amico we strongly believe that your data privacy
        ...
        <Text>
          ...
          requirements of GDPR. Amico processes or stores all personal data in
          ...
          days. We are aware that if you are working with EU customers, you need
          ...
          you to answer any questions you might have about working with the API.
          To request a copy of your data, please send us an email at
          info@Amico.co
        </Text>
        ...
        <Text>
          ...
          California residents have under California law.{" "}
        </Text>
        ...
        <Text>
          We do not sell the Personal Information of our users. For more
