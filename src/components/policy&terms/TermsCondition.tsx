...
const Terms = () => {
    return (
      <ScrollView style={styles.container}>
        ...
        <Text>• Country refers to: United States.</Text>
        <Text>
          • Company (referred to as either "the Company", "We", "Us" or "Our" in
          this Agreement) refers to Noosk, Inc., 1209 Orange Street, Wilmington
          (DE), 19801.
        </Text>
        <Text>
          • Content refers to content such as text, images, videos or other
        ...
        <Text>
          • Service refers to the Amico Website and to the Mobile Application.
        </Text>
        <Text>
        ...
        <Text>• Website refers to Amico, accessible at amico.noosk.co</Text>
        <Text>
        ...
        <Text style={styles.subHeader}>Your Right to Post Content</Text>
        <Text>
        ...
        <Text>
          By posting Content to the Service, You grant Us a worldwide
          non-exclusive, royalty-free, transferable, sub-licensable, and
          assignable license to perpetually and irrevocably use, modify,
          publicly perform, publicly display, reproduce, create derivative works
          from and distribute such Content on and through the Service. You
        ...
        <Text style={styles.subHeader}>Content Guidelines</Text>
        <Text>
          For further information about content on Noosk, including how to
          request content to be removed, please read our Content Guidelines .
        </Text>

        <Text style={styles.subHeader}>Content Backups</Text>
        <Text>
        ...
        <Text style={styles.subHeader}>Copyright Policy</Text>
        ...
        <Text>
          ...
          our copyright agent via email at info@noosk.co and include in Your
        ...
        <Text>
          Please refer to the Content Guidelines section of this document.
        </Text>
        <Text style={styles.subSubHeader}>
        ...
        <Text>• Your address, telephone number, and email address.</Text>
        <Text>
        ...
        <Text>
          You can contact our copyright agent via email at info @ noosk.co. Upon
        ...
        <Text style={styles.subSubHeader}>Intellectual Property</Text>
        <Text>
        ...
        <Text style={styles.subSubHeader}>Your Feedback to Us</Text>
        <Text>
        ...
        <Text style={styles.subSubHeader}>Links to Other Websites</Text>
        <Text>
        ...
        <Text style={styles.subHeader}>Dispute Resolution</Text>
        <Text>
        ...
        <Text style={styles.subSubHeader}>Severability</Text>
        <Text>
        ...
        <Text style={styles.subSubHeader}>Waiver</Text>
        <Text>
        ...
        <Text>By email: info@noosk.co</Text>
      </ScrollView>
    );
  };
